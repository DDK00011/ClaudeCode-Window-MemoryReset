...
print -r -- ""; print -r -- "${C_CYAN}[1] 절대 종료 금지 — Claude Desktop 앱${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[2] 절대 종료 금지 — GUI IDE 본체${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[3] 종료 대상 — Claude Code CLI (네이티브 설치)${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[4] 종료 대상 — Claude Code CLI (npm / IDE 확장)${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[5] 종료 대상 — Codex CLI${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[6] 무관한 프로세스 — 건드리면 안 됨${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[7] 고아 판정 (macOS 재부모화 규칙)${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[8] 분류(categorize)${C_RESET}"
...
print -r -- ""; print -r -- "${C_CYAN}[9] zsh 함정 회귀 가드${C_RESET}"
